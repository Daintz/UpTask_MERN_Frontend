...
const Search = () => {
  ...
  const filteredProjects = searchFor === '' ? [] : projects.filter(project => project.name.toLowerCase().includes(searchFor.toLowerCase()));

  return (
    <Transition.Root show={search} as={Fragment} afterLeave={() => setSearchFor('')}>
